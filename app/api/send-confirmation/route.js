...
export async function POST(request) {
  try {
    ...
    const cancelLink = cancellationToken 
      ? '<a href="https://tension-barber.rs/api/cancel-reservation?token=' + cancellationToken + '" style="color: #ef4444; font-size: 12px; text-decoration: none;">Otkaži rezervaciju</a>'
      : ''
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 500px; background-color: #000000;">
          <tr>
            <td style="padding: 30px 20px 10px; text-align: center;">
              <h1 style="color: #ffffff; margin: 0; font-size: 28px; font-weight: bold; letter-spacing: 3px;">TENSION BARBER</h1>
              <p style="color: #888888; margin: 8px 0 0; font-size: 11px; text-transform: uppercase; letter-spacing: 2px;">Muški frizerski salon</p>
            </td>
          </tr>
          <tr>
            <td style="padding: 25px 20px; text-align: center;">
              ...
              <p style="color: #22c55e; margin: 8px 0 0; font-size: 16px; font-weight: 600;">Rezervacija potvrđena!</p>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td style="padding: 20px; text-align: center;">
              <p style="color: #666; margin: 0 0 15px; font-size: 12px;">Vidimo se! 🤙</p>
              ${cancelLink}
            </td>
          </tr>
        </table>
